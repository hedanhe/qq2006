...
class myframe(wx.Frame):
    ...
    def __init__(self):
        ...
        image = wx.Image('resources/images/10.jpg',wx.BITMAP_TYPE_JPEG)
        ...
        mid = wx.Panel(parent=self, style=wx.BORDER_DOUBLE, pos=(400,400), size=(300, 300))

        accountid_st = wx.StaticText(mid, wx.ID_ANY, 'QQ号码', pos=(10,10))
        password_st = wx.StaticText(mid, wx.ID_ANY, 'QQ密码', pos=(10,50))
        ...
        mytxt = wx.TextCtrl(mypanel,size=(100,200),pos=(550,2),style=wx.TE_MULTILINE|wx.HSCROLL)
